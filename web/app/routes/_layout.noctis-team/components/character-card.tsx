      ...
      <div className="flex min-w-0 flex-row items-center gap-3">
        <div className="relative flex h-14 w-10 shrink-0 items-end justify-center">
          ...
          <img
            ...
            src={imageSrc}
            className={cn(
              "relative z-10 h-full w-full object-contain object-bottom transition-all duration-500",
              isBenched && "opacity-45 saturate-[0.45] brightness-90",
        ...
        <div className="min-w-0 flex-1">
          ...
          {detail && (
            <p
              className={cn(
                "mt-0.5 truncate font-mono text-[9px] text-muted-foreground/50 transition-colors duration-300",
                isBenched && "text-muted-foreground/35"
              )}
            >
              {detail}
            </p>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="mt-1.5 cursor-help">
                  ...
                  <div
                    className={cn(
                      "h-1.5 w-full overflow-hidden rounded-full bg-border/40 transition-colors duration-300",
                      isBenched && "bg-border/25"
                    )}
                  >
                    <div
                      className={cn(
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isBenched ? "bg-muted-foreground/35" : "bg-emerald-400"
                      )}
                    />
                  </div>
                </div>
        ...
        <div className="flex w-20 shrink-0 flex-col items-stretch gap-1 self-start pt-0.5">
          ...
          <div
            className={cn(
              "w-full rounded-full border px-2 py-0.5 text-center font-mono text-[9px] font-semibold uppercase tracking-widest transition-opacity duration-300",
