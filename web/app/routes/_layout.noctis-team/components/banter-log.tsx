          ...
          {entries.map((entry) => {
            ...
            return (
              <div
                ...
                style={{
                  borderColor: showActiveHighlight
                    ? (theme?.ring ?? "rgba(125, 211, 252, 0.4)")
                    : undefined,
                  background: showActiveHighlight
                    ? (theme?.surfaceStrong ?? "rgba(14, 165, 233, 0.12)")
                    : undefined,
                  boxShadow: showActiveHighlight
                    ? `0 0 24px ${theme?.glowSoft ?? "rgba(125,211,252,0.2)"}`
                    : undefined,
